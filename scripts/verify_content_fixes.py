...
def test_stage4_graph_imports():
    ...
    try:
        ...
        assert "def _extract_text_content(content)" in content, "Helper function should exist"
        print("✅ stage4_graph._extract_text_content exists")
        
        # Check helper implementation
        assert "isinstance(content, str)" in content, "Helper should handle string content"
        assert "isinstance(content, list)" in content, "Helper should handle list content"
...
def test_llm_has_responses_api_param():
    ...
    try:
        ...
        assert "use_responses_api=True" in content, "llm.py should have use_responses_api=True"
...
def test_api_main_has_helper():
    ...
    try:
        ...
        assert "_extract_text_content(msg.content)" in content, "Helper should be used in streaming"
...
def test_stage4_graph_uses_helper():
    ...
    try:
        ...
        critical_uses = [
            ...
            ("agent_msgs summary", "_extract_text_content(m.content) for m in agent_msgs"),
