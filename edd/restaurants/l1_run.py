"""Run Restaurant Layer 1 evaluators against live, cached trajectories."""
...
from edd.restaurants.l1_evaluate import EVALUATORS  # noqa: E402
...
async def main() -> None:
    print(
        f"\nRestaurants agent - Layer 1 over {len(DATASET)} cases"
