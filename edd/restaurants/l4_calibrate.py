"""Calibrate the Restaurant faithfulness judge against human labels."""
...
from edd.restaurants.l2_judge import (  # noqa: E402
    build_judge,
    judge_faithfulness,
)
from edd.restaurants.l2_judge_cases import JUDGE_CASES  # noqa: E402
...
async def main() -> None:
    ...
    await run_calibration(
        ...
        cases=JUDGE_CASES,
        agent="Restaurants",
        rubric_module="edd/restaurants/l2_judge.py",
    )
