"""Run Activities Layer 2 judges over cached live trajectories."""
...
from edd.activities.l2_judge import JUDGES, build_judge  # noqa: E402
...
async def main() -> None:
    print(
        f"\nActivities agent - Layer 2 over {len(DATASET)} cases"
