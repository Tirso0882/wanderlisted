"""Observe one traced ActivitiesAgent trajectory before evaluating it."""
...
from edd.activities.run_utils import _redact_sensitive_text  # noqa: E402
from edd.harness import run_agent  # noqa: E402
from src.agent.agents import ActivitiesAgent  # noqa: E402
...
async def main() -> None:
    ...
    with collect_runs() as runs_callback:
        trajectory = await run_agent(ActivitiesAgent, query)
