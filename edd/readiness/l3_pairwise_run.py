"""Run a readiness Layer 3 round-robin model tournament."""
...
from edd.readiness.l3_pairwise import (  # noqa: E402
...
async def main() -> None:
    ...
    print(
        f"\nReadiness agent - Layer 3 over {len(DATASET)} cases"
    ...
    for name in LINEUP:
        trajectories[name] = await run_readiness_dataset(
    ...
    print("\n" + "=" * 74)
    print("LEADERBOARD - win rate (ties = 1/2), best readiness model first:")
