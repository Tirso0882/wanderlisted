"""Calibrate the readiness faithfulness judge against human labels."""
...
from edd.readiness.l2_judge import build_judge, judge_faithfulness  # noqa: E402
from edd.readiness.l2_judge_cases import JUDGE_CASES  # noqa: E402
...
async def main() -> None:
    ...
    await run_calibration(
        ...
        cases=JUDGE_CASES,
        agent="Readiness",
        rubric_module="edd/readiness/l2_judge.py",
    )
