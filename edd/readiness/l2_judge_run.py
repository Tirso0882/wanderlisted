"""Run readiness Layer 2, reusing an exact cache or capturing live on a miss."""
...
from edd.readiness.l2_judge import JUDGES, build_judge  # noqa: E402
...
async def main() -> None:
    print(
        f"\nReadiness agent - Layer 2 over {len(DATASET)} cases"
    ...
    record_component_report(
        ...
        context={
            ...
            "planner_model": "deterministic readiness planner",
        },
        report_source_files=(
            Path(__file__),
