...
```python
params = {"access_key": os.environ["EXCHANGERATE_API_KEY"]}
```

**Used by:** ExchangeRate API
...
| Tavily Search | Tavily | API key | Destination pipeline, `search_destination_web` | `TAVILY_API_KEY` |
