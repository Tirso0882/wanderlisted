...
| Frontend runtime | Server-only `API_URL`; locale-specific `CONSULTATION_URL_EN`/`CONSULTATION_URL_PL`; never bake environment URLs into the client image |
